...
class Shape : public Drawable
{
	...
	public:
		 ...
		 */
		virtual int area() const;			// Made into virtual function since "shape" cannot produce pre-defined area
		 ...
		 */
		virtual int perimeter() const;		// Made into virtual function since "shape" cannot produce pre-defined area

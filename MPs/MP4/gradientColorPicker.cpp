...
{
	RGBAPixel color;
	int Manhattan = abs(center_x -x) + abs(center_y - y);
	if(Manhattan <= rad) 
	{	
		color.red = color1.red - floor(Manhattan*color1.red/rad) + floor(Manhattan*color2.red/rad);
		color.green = color1.green - floor(Manhattan*color1.green/rad) + floor(Manhattan*color2.green/rad);
		color.blue = color1.blue - floor(Manhattan*color1.blue/rad) + floor(Manhattan*color2.blue/rad);
	}
	else
		color = color2;
